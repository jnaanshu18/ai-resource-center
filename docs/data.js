...
const TOOLS = [
  ...
  },
  {
    ...
    "status": "Approved",
    "url": "https://julius.ai",
    "videoUrl": "https://www.youtube.com/watch?v=ir8qShUBCco",
    "description": "Conversational data analyst for CSV and spreadsheet questions, charts, and ad hoc exploration in plain English.",
    "platform": [
      "Web"
    ],
    ...
    "notes": "Approved for quick analysis of sample or Internal spreadsheets. Not a replacement for Power BI on client delivery.",
    "limitations": "Uploads leave our environment. Quality drops on messy files. Do not use client-confidential or production extracts.",
    "whenToUse": "Ad hoc CSV or spreadsheet exploration when you need charts and answers without a full BI build.",
    "alternatives": "Power BI Copilot for Fabric/Power BI delivery; ChatGPT for light table questions without file upload.",
    "costNote": "Freemium; paid plans for larger files and higher limits.",
    "securityTip": "Internal or sample data only. Do not upload client Confidential files.",
    "approvedModels": [
      "GPT"
    ]
  },
  {
    ...
    "videoUrl": "https://www.youtube.com/watch?v=OdCmZvPdr4s",
    "description": "Google document Q&A and briefing tool that grounds answers in notebooks you upload, for research packs and internal synthesis.",
    "platform": [
      "Web"
    ],
    "department": "Everyone",
    ...
    "dateAdded": "2026-07-07",
    "lastReviewed": "2026-08-20",
    "notes": "Approved for Q&A over internal briefing packs. Not a substitute for Perplexity on open-web research.",
    "limitations": "Answers only from uploaded sources. Do not upload client-confidential files without approval.",
    "whenToUse": "Ask questions and draft briefings grounded in your own doc packs, notes, and PDFs.",
    "alternatives": "Perplexity for cited web research; Notion AI for writing inside Notion; ChatGPT/Claude for general synthesis.",
    "costNote": "Free with a Google account; Google One/AI tiers may add limits or features.",
    "securityTip": "Internal docs only unless a lead approves the upload. No client Confidential files by default.",
    "approvedModels": [
      "Gemini"
    ]
  },
  {
    ...
    "status": "Approved",
    "url": "https://gamma.app",
    "videoUrl": "https://www.youtube.com/watch?v=KcbXKUR7-a0",
    "description": "AI presentation and one-pager builder that turns an outline into a polished first-draft deck for storytelling and updates.",
    "platform": [
      "Web"
    ],
    "department": "Operations",
    ...
    "dateAdded": "2026-07-07",
    "lastReviewed": "2026-08-20",
    "notes": "Approved for fast internal and first-pass client decks. Humans still polish brand and facts before send.",
    "limitations": "Brand match and accuracy need a review pass. Not a replacement for designed master templates.",
    "whenToUse": "When you need a first-draft slide deck or one-pager from an outline, then edit before external use.",
    "alternatives": "ChatGPT for outline-only drafts; Notion AI for written briefs without slides.",
    "costNote": "Freemium; paid plans for more AI generations and export options.",
    "securityTip": "Do not paste client Confidential content into public Gamma workspaces.",
    "approvedModels": [
      "GPT",
      "Gemini"
    ]
  },
  {
    ...
    "videoUrl": "https://www.youtube.com/watch?v=LHZN8LGuE9s",
    "description": "Web hosting, domains, and AI-assisted site building (Website Builder and Horizons) for launching and managing team and client sites.",
    "platform": [
      "Web"
    ],
    "department": "Operations",
    ...
    "lastReviewed": "2026-08-20",
    "notes": "Approved hosting and AI website-builder option for DCS sites. Keep production credentials in the DCS account, not personal logins.",
    "limitations": "AI-generated sites still need review for accessibility, brand, and security before client go-live.",
    "whenToUse": "When you need hosting, a domain, WordPress, or a first-pass AI website without standing up custom infrastructure.",
    "alternatives": "Existing DCS cloud or Pages hosting for app deploys; v0/Lovable for UI prototypes that are not hosted sites.",
    "costNote": "Paid hosting plans; confirm who owns the DCS subscription and domains.",
    "securityTip": "Use the DCS Hostinger account. Enable 2FA. Do not store client secrets in hPanel notes or AI chat.",
    "approvedModels": [
      "GPT",
      "Gemini"
    ]
...
const EVALUATIONS = {
  ...
  "NotebookLM": {
    ...
    "recommendation": "★★★★☆",
    "date": "2026-08-20",
    "notes": "Approved for internal doc Q&A and briefing packs — no client-confidential uploads without approval",
    "evaluator": "DCS catalog review"
  },
  "CodeRabbit": {
    "score": "",
  ...
  "Julius AI": {
    ...
    "recommendation": "★★★★☆",
    "date": "2026-08-20",
    "notes": "Approved for Internal/sample CSV exploration — not for confidential client extracts",
    "evaluator": "DCS catalog review"
  },
  "n8n": {
    "score": "2.8",
  ...
  "Gamma": {
    ...
    "recommendation": "★★★☆☆",
    "date": "2026-08-20",
    "notes": "Approved for fast first-pass decks — review branding and accuracy before external use",
    "evaluator": "DCS catalog review"
  },
  "Hostinger": {
    "score": "3.6",
    "criteria": "Ease of use, Hosting fit, AI builder",
    "recommendation": "★★★☆☆",
    "date": "2026-08-20",
    "notes": "Approved for DCS hosting and AI-assisted site launches — keep credentials on the DCS account",
    "evaluator": "DCS catalog review"
  },
  "OpenHands": {
    "score": "",
...
const TEAM_MEMBERS = [
  ...
  },
  {
    "id": "TM-003",
    "name": "Aagam Jain",
    "email": "aagam@dailycodesolutions.com",
    "department": "Engineering",
    "role": "Admin",
    "active": true
  },
  {
    "id": "TM-004",
    "name": "Sourabh Jain",
    "email": "sourabh@dailycodesolutions.com",
    "department": "Engineering",
    "role": "Team",
    "active": true
  },
  {
    "id": "TM-005",
    "name": "Chinmay Jain",
    "email": "chinmay@dailycodesolutions.com",
    "department": "Engineering",
    "role": "Team",
    "active": true
  },
  {
    "id": "TM-006",
    "name": "Parmeshver",
    "email": "parmeshver@dailycodesolutions.com",
    "department": "Engineering",
    "role": "Team",
    "active": true
  },
  {
    "id": "TM-007",
    "name": "Karan Longani",
    "email": "karan@dailycodesolutions.com",
    "department": "Engineering",
    "role": "Team",
    "active": true
  }
...
const SUBMISSIONS = [
  {
    ...
    "Submitted by": "Akshay",
    "Why Suggested": "Suggested for AI image generation on client moodboards and creative concepts. Useful when decks need custom visuals beyond stock art.",
    "Why Rejected": "",
    "Note": "",
    "Status": "New",
    "Assigned to": "",
  ...
  },
  {
    ...
    "Why Suggested": "Suggested for natural voiceovers in product demos and explainer videos. Check data handling before using any client audio.",
    "Why Rejected": "",
    "Note": "",
    "Status": "In review",
    "Assigned to": "Akshay",
  ...
  },
  {
    ...
    "Link": "https://groq.com/",
    "Submitted by": "Akshay",
    "Why Suggested": "Suggested for very fast LLM inference on prototypes and latency-sensitive demos. Compare response times with our hosted models.",
    "Why Rejected": "",
    "Note": "",
    "Status": "In review",
  ...
  },
  {
    ...
    "Submitted by": "Anshu Jain",
    "Why Suggested": "Suggested for AI video editing and short promo clips. Helpful for marketing samples without a full production setup.",
    "Why Rejected": "",
    "Note": "",
    "Status": "Approved",
    "Assigned to": "Anshu Jain",
  ...
  },
  {
    ...
    "Submitted by": "Akshay",
    "Why Suggested": "Suggested for editing podcasts and screen recordings by editing the transcript. Cuts post-production time on talking-head content.",
    "Why Rejected": "",
    "Note": "",
    "Status": "New",
    "Assigned to": "",
  ...
  },
  {
    ...
    "Submitted by": "Anshu Jain",
    "Why Suggested": "Suggested as a hub for open models datasets and demo Spaces. Useful for trying models before we commit to a stack.",
    "Why Rejected": "",
    "Note": "",
    "Status": "In review",
    "Assigned to": "Akshay",
  ...
  },
  {
    ...
    "Submitted by": "Akshay",
    "Why Suggested": "Suggested for AI presenter and avatar videos.",
    "Why Rejected": "Outputs feel too branded for client-facing DCS work.",
    "Note": "",
    "Status": "Rejected",
    "Assigned to": "Anshu Jain",
    "Assigned date": "",
  ...
  },
  {
    ...
    "Submitted by": "",
    "Why Suggested": "Suggested for browser-based coding with an AI agent on quick spikes. Compare with Cursor when production ownership matters.",
    "Why Rejected": "",
    "Note": "",
    "Status": "New",
    "Assigned to": "",
  ...
  },
  {
    ...
    "Link": "https://bolt.new",
    "Submitted by": "",
    "Why Suggested": "Suggested for rapid full-stack prototypes from a prompt. Compare with Lovable and v0 on speed vs polish for internal demos.",
    "Why Rejected": "",
    "Note": "",
    "Status": "In review",
    "Assigned to": "Anshu Jain",
  ...
  },
  {
    ...
    "Submitted by": "",
    "Why Suggested": "Suggested as an AI-native IDE alternative to Cursor for teams who want a different agentic coding workflow.",
    "Why Rejected": "",
    "Note": "",
    "Status": "New",
    "Assigned to": "",
  ...
  },
  {
    ...
    "Submitted by": "",
    "Why Suggested": "Suggested to auto-capture meeting notes, action items, and call summaries. Could reduce manual follow-up after client calls.",
    "Why Rejected": "",
    "Note": "",
    "Status": "New",
    "Assigned to": "",
  ...
  },
  {
    ...
    "Link": "https://exa.ai",
    "Submitted by": "",
    "Why Suggested": "Suggested for AI-native web search and research APIs. Fits agent workflows that need fresher sources than generic search.",
    "Why Rejected": "",
    "Note": "",
    "Status": "New",
    "Assigned to": "",
  ...
  },
  {
    ...
    "Submitted by": "",
    "Why Suggested": "Suggested for no-code automation between SaaS tools. Lighter option when full agent platforms are more than we need.",
    "Why Rejected": "",
    "Note": "",
    "Status": "New",
    "Assigned to": "",
  ...
  },
  {
    ...
    "Submitted by": "",
    "Why Suggested": "Suggested for generating web app prototypes from prompts. Good for validating ideas before custom UI investment.",
    "Why Rejected": "",
    "Note": "",
    "Status": "New",
    "Assigned to": "",
  ...
  },
  {
    ...
    "Submitted by": "",
    "Why Suggested": "Suggested for engineers in a launcher workflow—quick AI answers and snippets without leaving the keyboard.",
    "Why Rejected": "",
    "Note": "",
    "Status": "New",
    "Assigned to": "",
  ...
  },
  {
    ...
    "Submitted by": "Admin",
    "Why Suggested": "Suggested for turning websites into clean LLM-ready markdown for RAG. Cleaner than maintaining brittle custom scrapers.",
    "Why Rejected": "",
    "Note": "",
    "Status": "New",
    "Assigned to": "",
  ...
  },
  {
    ...
    "Submitted by": "Admin",
    "Why Suggested": "Suggested for managed web scraping on e-commerce monitoring and client crawl projects. Offloads ops on scheduled extracts.",
    "Why Rejected": "",
    "Note": "",
    "Status": "New",
    "Assigned to": "",
  ...
  },
  {
    ...
    "Submitted by": "Admin",
    "Why Suggested": "Suggested as a Python-first crawler built for LLM ingestion. Pairs well with our RAG stack and browser automation work.",
    "Why Rejected": "",
    "Note": "",
    "Status": "New",
    "Assigned to": "",
  ...
  },
  {
    ...
    "Submitted by": "Admin",
    "Why Suggested": "Suggested for running models locally when data must stay on-device. Complements cloud tools—not a full Claude or ChatGPT replacement.",
    "Why Rejected": "",
    "Note": "",
    "Status": "New",
    "Assigned to": "",
  ...
  },
  {
    ...
    "Submitted by": "Admin",
    "Why Suggested": "Suggested for DCS Power BI delivery—natural language DAX report building and summaries. Confirm Microsoft licensing on client work.",
    "Why Rejected": "",
    "Note": "",
    "Status": "New",
    "Assigned to": "",
  ...
  },
  {
    ...
    "Link": "https://dify.ai",
    "Submitted by": "Admin",
    "Why Suggested": "Suggested for client RAG apps and internal knowledge bots with a visual builder. Self-host when data residency matters.",
    "Why Rejected": "",
    "Note": "",
    "Status": "New",
    "Assigned to": "",
  ...
  },
  {
    ...
    "Link": "https://v0.dev",
    "Submitted by": "Admin",
    "Why Suggested": "Suggested for fast React and Next UI generation from prompts. Useful for client mockups and exportable front-end starts.",
    "Why Rejected": "",
    "Note": "",
    "Status": "New",
    "Assigned to": "",
  ...
  },
  {
    ...
    "Submitted by": "Admin",
    "Why Suggested": "Suggested for document Q&A, briefing packs, and research synthesis. Use internal docs only—avoid confidential client files unless approved.",
    "Why Rejected": "",
    "Note": "",
    "Status": "Approved",
    "Assigned to": "",
  ...
  },
  {
    ...
    "Submitted by": "Admin",
    "Why Suggested": "Suggested for automated PR reviews with line-level feedback and security checks. Fits teams on GitHub or GitLab workflows.",
    "Why Rejected": "",
    "Note": "",
    "Status": "New",
    "Assigned to": "",
  ...
  },
  {
    ...
    "Submitted by": "Admin",
    "Why Suggested": "Suggested for quick CSV analysis charts and spreadsheet questions in plain English. Best on sample or internal data.",
    "Why Rejected": "",
    "Note": "",
    "Status": "Approved",
    "Assigned to": "",
  ...
  },
  {
    ...
    "Submitted by": "Admin",
    "Why Suggested": "Suggested for polished slide decks and one-pagers from an outline. Speeds up client storytelling and internal updates.",
    "Why Rejected": "",
    "Note": "",
    "Status": "Approved",
    "Assigned to": "",
  ...
  },
  {
    ...
    "Submitted by": "Admin",
    "Why Suggested": "Suggested as an autonomous coding agent for multi-step dev tasks. Revisit once our primary IDE workflow is settled.",
    "Why Rejected": "",
    "Note": "",
    "Status": "New",
    "Assigned to": "",
  ...
  },
  {
    ...
    "Submitted by": "Admin",
    "Why Suggested": "Suggested for Python browser automation driven by LLM agents. Strong fit for scripted scraping and QA on Playwright.",
    "Why Rejected": "",
    "Note": "",
    "Status": "New",
    "Assigned to": "",
